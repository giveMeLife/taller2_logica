...
tamano_taza['grande'] = fuzz.trimf(tamano_taza.universe, [150,420, 420])
...
temperatura_ambiental['caluroso'] = fuzz.trimf(temperatura_ambiental.universe, [27,42, 42])
...
nivel_agua['mucha'] = fuzz.trimf(nivel_agua.universe, [150,420,420])
...
tiempo_preparacion['mucha'] = fuzz.trimf(tiempo_preparacion.universe, [1.8,2,2.8])
